...
if (csvOnly) {
  ...
  return vfResult();
    ...
    for (var li2 = 0; li2 < indices.length; li2++) {
      ...
      // РЎРѕР±РёСЂР°РµРј СЌРєСЃРїРѕСЂС‚РЅС‹Рµ СЃР»РѕРё РІ Р¤РРљРЎРР РћР’РђРќРќРћРњ РїРѕСЂСЏРґРєРµ (СЃРІРµСЂС…Сѓ РІРЅРёР· РїР°РЅРµР»Рё
      // Layers): FG, FG_CLIP, PLACEHOLDERS, ART_CLIP, BG, BG_CLIP, BG_0, BG_0_CLIP.
      // РљР°Р¶РґС‹Р№ СЃР»РѕР№ РєРѕРїРёСЂСѓРµС‚СЃСЏ РІ РґРІРµ С‡Р°СЃС‚Рё вЂ” РѕР±С‹С‡РЅС‹Рµ РѕР±СЉРµРєС‚С‹, Р·Р°С‚РµРј clipping
      // group РґР»СЏ РѕР±СЉРµРєС‚РѕРІ РІРЅРµ Р°СЂС‚Р±РѕСЂРґР° (СЃРј. copyLayerItems).
      var exportOrder = [
...
function buildStockCsv(
  ...
  // Returns the non-empty TextFrame with the largest area (width � height
